const Tile = ({players}) =>{
    ...
    return <div className='w-full h-full bg-black border text-white'>
        ...
        {players?.includes('0') && <div className='bg-violet-500'>0</div>}
        {players?.includes('1') && <div className='bg-red-500 p-[0.1rem]'>1</div>}
        {players?.includes('2') && <div className='bg-blue-500 p-[0.1rem]'>2</div>}
        {players?.includes('3') && <div className='bg-green-500 p-[0.1rem]'>3</div>}
    </div>
}
